...
BLOG_AUTHOR = "Avinash Ummadisingu"  # (translatable)
BLOG_TITLE = "About Machines That Learn & Think"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://ummavi.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://ethrealrain.github.io/"
BLOG_EMAIL = "u.avinash4x@gmail.com"
BLOG_DESCRIPTION = "A blog where I plan to lay down thoughts about AI (Particularly Reinforcement Learning) and understanding of concepts and papers I read about them."  # (translatable)
BLOG_TWITTER = "ummavi"
BLOG_FACEBOOK = "ethrealx"
BLOG_GITHUB="ummavi"
BLOG_LINKEDIN = "avinashumm"
